...
def xoshnaw():
  ...
  id = "-".join(uuid)
  print("\x1b[1;92mID KAMU ADALAH\x1b[1;91m : "+id)
  try:
    httpCaht = requests.get("https://github.com/FLAME-XD/activated/blob/main/data/asu.txt").text
    if id in httpCaht:
      print("\x1b[1;96mSTATUS ID ANDA: AKTIF \033[1;92m[✔]")
      msg = str(os.geteuid())
      time.sleep(1)
      pass
    else:
      print("\x1b[38;5;248mID ANDA TIDAK AKTIF \x1b[1;91m[✘]")
      print("\x1b[38;5;208mSILAHKAN COPY ID ANDA KIRIM KE WHAT'SAPP !!!")
      os.system('xdg-open https://wa.me/+6281327765366?text=BANG+SAYA+MAU+ORDER+SC+CRACK+IG+KAMU+BANG')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
